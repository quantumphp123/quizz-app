...
<head>
    ...
    <style>
        ...
        .bg{
            ...
            background-image: url(https://images.rawpixel.com/image_1300/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIyLTA2L3ZwOTM4LWF1ZGktMDEteC5qcGc.jpg);
            height:100%;
            width:100%;
            position:absolute;
        ...
        <div style="margin:50%" class="m-5">
                ...
                <div class="form-group d-flex justify-content-start">
                        <small class="text-left">
                            <a href="{{ route('teacherSignup') }}" class="text-primary">New Here? Signup</a>
                        </small>
                </div>
                        <!-- form here -->
