...
Route::prefix('teacher')->group(function () {
    ...
    Route::get('forgot-password',[TeacherController::class,'forgot_password'])->name('teacher.forgot.password');
    Route::post('forgot-password',[TeacherController::class,'forgot_password_post'])->name('teacher.forgot.password.post');
    Route::get('reset-password/{token}/{email}',[TeacherController::class,'reset_password'])->name('teacher.reset.password');
    Route::post('reset-password',[TeacherController::class,'reset_password_post'])->name('teacher.reset.password.post');
...
Route::prefix('parent')->group(function () {
    ...
    Route::get('forgot-password',[ParentController::class,'forgot_password'])->name('parent.forgot.password');
    Route::post('forgot-password',[ParentController::class,'forgot_password_post'])->name('parent.forgot.password.post');
    Route::get('reset-password/{token}/{email}',[ParentController::class,'reset_password'])->name('parent.reset.password');
    Route::post('reset-password',[ParentController::class,'reset_password_post'])->name('parent.reset.password.post');
