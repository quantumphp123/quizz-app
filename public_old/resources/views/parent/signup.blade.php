...
<body class="d-flex justify-content-center align-items-center ">
    <div class="box">
        ...
        <ul class="pl-3">
            <li class="font-weighted-bold">Signup as Parent</li>
        </ul>
        <div class="row">
            <div class="col-12">
                <!-- form here -->
                ...
                <div class="form-group d-flex justify-content-start">
                        <span class="text-left">
                            <a href="{{ route('parent.login') }}" class="text-primary">Already Have an Account? Login Instead</a>
                        </span>
                </div>
                <form action="{{route('parent.signup.post')}}" method="POST">
                    @csrf
