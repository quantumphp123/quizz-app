...
<head>
    ...
    <style>
        body {
            ...
            background-image: linear-gradient(to top, #FEBE10, #FFC72C, #F0E68C);
        ...
        .bg {
            ...
            background-image: url(https://www.pngitem.com/pimgs/m/112-1128071_system-analysis-clipart-hd-png-download.png);
            height: 100%;
            width: 100%;
            /* position:absolute; */
            ...
            <div class="col-lg-7 p-0">
                ...
                <div style="height:100%; width: 100%;">
                    <img style="width:100%; height:100%"
                        src="https://www.pngitem.com/pimgs/m/112-1128071_system-analysis-clipart-hd-png-download.png" />
                </div>

            </div>
            <div class="col-lg-5  align-items-center" style="background-color: white;margin-block: 0;">
                                ...
                                <form action="{{ route('adminLoginPost') }}" method="post">
                                    ...
                                    {{-- <button type="submit"
                                        class="btn btn-block bg-white border border-black ml-0 my-2"> <img
                                            src="./asset/googIcon.png" width="30px" height="30px" alt="..."> Log in with
                                        Google</button> --}}
                                </form>
                            </div>
                        </div>
