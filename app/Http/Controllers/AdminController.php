...
// return $details;
    ...
    public function post_add_parent(Request $request) {
        ...
        $body = 'Thankyou '.$request->name." for Registering with Quiz App.<br><br>Your Login Credentials are Following<br><strong>Email</strong> ".$request->email."<br><strong>Password </strong>".$password. "<br><br><strong>NOTE<strong> <i>Please Change the Password Once After Logged In</i>";
        ...
        \Mail::mailer('sendmail')->to($request->email)->send(new Password($data));
