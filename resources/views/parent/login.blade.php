...
<head>
    ...
    <style>
        body {
            ...
            background-image: linear-gradient(to top, #004a79, #035d9c, #a8dbee);
            ...
            <div class="col-lg-7 p-0">
                ...
                <div style="height:100%; width: 100%;">
                    <img style="width:100%; height:100%"
                        src="https://images.rawpixel.com/image_1300/czNmcy1wcml2YXRlL3Jhd3BpeGVsX2ltYWdlcy93ZWJzaXRlX2NvbnRlbnQvbHIvdjg3M2JhdGNoNC1hZXctMDVfMS5qcGc.jpg" />
                </div>

            </div>
            <div class="col-lg-5 my-auto mx-auto align-items-center" style="background-color: white;">
                                        ...
                                        <form action="{{ route('parent.login.post') }}" method="post">
                                            ...
                                            <div class="form-group d-flex justify-content-end">
                                                <small class="text-right">
                                                    <a href="{{ route('parent.forgot.password') }}"
                                                        class="text-primary">Forgot Password?</a>
                                                </small>
                                            </div>
                                            <button type="submit" class="btn btn-block btn-primary ml-0 my-2">Log
                                                in</button>
                                            {{-- <button type="submit"
                                                class="btn btn-block bg-white border border-black ml-0 my-2"> <img
                                                    src="./asset/googIcon.png" width="30px" height="30px" alt="..."> Log
