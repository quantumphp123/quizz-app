    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-7-xxxl col-12">
            <div class="card dashboard-card-six">
                <div class="card-body">
                    <div class="heading-layout1 mg-b-17 mb-2">
                    ...
                    <div class="notice-box-wrap m-height-660">
                        <div>
                            ...
                            <div class="m-2">
                                ...
                                <div>
                                    @foreach ($kids as $kid)
                                    <a href="{{ route('student-notifies', $kid->id) }}" role="button"
                                        class="btn px-4 py-2 mr-3 mt-4"
                                        style="background-color: {{ $kid->hex }}; color: black">
                                        {{ ucwords($kid->name) }}
                                    </a>
                                    @endforeach
                        ...
                        <div class="notice-list pt-4">
                            ...
                            <div class="entry-meta">{{ ucwords($notify['teacher_name']) }}</span></div>
                        </div>
                        @endforeach
                        @else
                        <div class="notice-list mt-5 mb-0">
                                    ...
                                    <div class="item-content table-responsive">
                                        ...
                                        <div class="m-2">
                                            ...
                                            <div class="mt-5">
                                                ...
                                                <a href="{{ route('parent.viewPoints', $kid->id) }}"
                                                    class="btn btn-success p-2 m-1">View Points</a>
                                                <a href="{{ route('parent.assignPoints', $kid->id) }}"
                                                    class="btn btn-success p-2 m-1">Assign Points</a>
                                                    <br>
                                                {{-- <a href="{{ route('parent.teacher.feedback', $kid->id) }}"
                                                    class="btn btn-outline-dark p-2 m-1"><i class="bi bi-clock-history">
                                                        History</i></a> --}}
                                                <a href="{{ route('parent.teacher.feedback', $kid->id) }}" class="ml-1">
                                                    <button type="button" class="btn btn-dark" data-toggle="tooltip"
                                                    data-placement="top" title="History">
                                                    <i class="bi bi-clock-history"></i>
                                                </button></a>
                                                <a href="{{ route('edit.kid', $kid->userId) }}"
                                                    class="btn btn-success p-2 m-1"><i
                                                        class="bi bi-pencil"></i></a>
                                                <a href="{{ route('parent.remove.kid', $kid->id) }}"
                                                    class="btn btn-del-kid btn-danger p-2 m-1"><i
        ...
        {{-- <div class="row">
                                ...
                                <div class="col-12-xxxl col-sm-12 col-12">
                                    ...
                                    <div class="kids-details-box mb-5 hover" id="{{ $kid->id }}"
                                        ...
                                        <div class="item-content table-responsive"> --}}
                                            ...
                                            {{-- <a href="{{route('parent.teacher.feedback', $kid->id)}}" role="button"
                                                class="btn btn-outline-primary">
                                                <i class="fa-solid fa-message"></i>&nbsp;History
                                            </a>
                                            <a href="{{route('parent.remove.kid', $kid->id)}}" role="button"
                                                class="btn btn-outline-danger btn-del-kid">
                                                <i class="fa-solid fa-trash"></i>
                                            </a>
                                            <a href="{{route('edit.kid', $kid->userId)}}" role="button"
            ...
            min-height: 20px">
                    <div class="card-body">
                        ...
                        <div class="pb-5">
                            @foreach ($kids as $kid)
                            <a href="{{ route('student-notifies', $kid->id) }}" role="button" class="btn px-4 py-2 mr-3"
                                style="background-color: {{ $kid->hex }}; color: black">
                                {{ ucwords($kid->name) }}
                            </a>
                            @endforeach
