...
<div class="dashboard-content-one">
    ...
    <div class="row d-flex flex-column" style="min-height: 85vh;">
        <!-- Dashboard summery Start Here -->
        <div>
            <div class="row">
                <div class="col-6-xxxl col-lg-6 col-sm-6 col-12 mt-3">
                    <div class="card-body">
                                ...
                                <div class="table-responsive" style="overflow-x:auto;">
                                    <table class="table display">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ date('d-M-Y',
                                                    strtotime(\Carbon\Carbon::parse($point->created_at)->startOfWeek()))
                                                    }}</td>
                                                <td>{{ date('d-M-Y',
                                                    strtotime(\Carbon\Carbon::parse($point->created_at)->endOfWeek()))
                                                    }}</td>
                                                <td>
                                                    @if ($point->total == 12)
                                                    31250
                                                ...
                                                <td><a href="{{ route('student.personal.weekly.points', [$point->studentId, $point->created_at, 'teacher']) }}"
                                                        role="button" class="btn btn-primary">View</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
