        ...
        <table class="table display data-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{route('teacher.group.show',$rows->id)}}"><button class="btn btn-primary">Group
                    Details</button></a>
                <a href="{{ route('teacher.group.delete', $rows->id) }}" class="btn-del"><button
                    class="btn btn-danger">Delete Group</button></a>
              </td>
            </tr>
            @php
            $i++;
            ...
            <!-- Modal -->
            <div class="modal fade" id="assignment{{$rows->id}}" tabindex="-1" role="dialog"
...
<!-- Modal -->
{{-- <div class="modal fade" id="createGroup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        <form action="{{ route('teacher.createGroup') }}" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control form-control-sm mb-3" id="group_name" name="group_name"
              placeholder="Enter group name..." required>
          </div>
          <div class="form-group">
            <label for="select_class">Select Class</label>

            <select name="class" class="form-control mb-3" id="select_class" onchange="return fetchStudentsList()"
              required>
          ...
          <select name="students[]" class="form-control form-control-sm select" id="select_students" multiple="multiple"
