            ...
            <div class="kids-details-box mb-5">
              <div class="item-img">
                <img src="{{ url('public/uploads/Students/'.$kid->profilePic) }}" alt="kids"
                  style="height:98px;width:98px;border-radius:10px;margin-left: auto;margin-right: auto;display: block;">
              </div>
              ...
              <div class="item-content table-responsive">
                <table class="table">
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <button type="button" class="btn btn-lg btn-success mt-3" data-toggle="modal"
                          data-target="#feedback{{$kid->id}}">
                          Feedback
                        </button>
                      ...
                      <td>
                        <a href="{{ route('teacher.remove.group.member',$kid->id) }}">
                          <button class="btn btn-del btn-danger btn-lg mt-3">Remove</button>
                        </a>
                      </td>
                    </tr>
                  </tbody>
                ...
                <div class="modal-body">
                  ...
                  <form action="{{ route('teacher.student.feedback') }}" method="post">
                    ...
                    <textarea class="form-control" name="description" id="description" cols="30" rows="8"
                      placeholder="Write about student..."></textarea>
