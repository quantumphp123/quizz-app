    ...
    <div style="margin:auto; margin-inline:10%">
        ...
        <div class="row main-box">
            ...
            <div class="col-lg-5 align-items-center" style="background-color: white;">
                ...
                <div style="margin-block:20%" class="box">
                    <div class="m-5">
            
                            
                            <p class="h2"><b>FORGOT PASSWORD</b></p>
                            <p class="text-secondary ">Welcome! Please enter your registered email. We will send you a link to reset your password.</p>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <!-- form here -->
                                    <form action="{{ route('teacher.forgot.password.post') }}" method="post">
                                        @csrf
                                        ...
                                        <button type="submit" class="btn btn-block btn-primary ml-0 my-2">Send Email</button>
