...
<head>
    ...
    <style>
        body {
            ...
            background-image: linear-gradient(rgba(12, 12, 12, 0.1), rgba(0, 0, 0, 0.1)), url('assets/main/asset/school-supply-stationary-background-free-vector copy.jpg'),linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 1) 100%);
        ...
        <div class="col-12 d-flex justify-content-center flex-wrap" style="height: 192px;">
            ...
            <div class="m-2">
                <a href="{{route('teacherLogin')}}" class="loginCard" id="card1">
                    <div class="card userCards d-flex text-center  align-items-center p-3" style="width: 176px; height: 192px;">
