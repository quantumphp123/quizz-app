            ...
            <div class="nav-bar-header-one">
                ...
                <div class="header-logo">
                    ...
                    <a href="index.html">
                        ...
                        <img src="{{url('assets/student/img/logo.png')}}" alt="logo">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                ...
                                <li class="nav-item">
                                    ...
                                    <a href="{{url('student/quiz-schedule')}}" class="nav-link"><i class="fas fa-angle-right"></i>Quiz
                                ...
                                <li class="nav-item">
                                    ...
                                    <a href="{{url('student/quiz-grades')}}" class="nav-link"><i class="fas fa-angle-right"></i>Quiz
