                                ...
                                <div class="kids-details-box mb-5">
                                    <div class="item-img">
                                      ...
                                      if($kid->profilePic == NULL) { ?>
                                        <img src="{{ url('public/dummyImages/dummy_user.jpeg') }}" alt="kids" style="margin-left: auto;margin-right: auto;display: block;height:98px;width:98px;border-radius:10px;">
                                      <?php } else { ?>
                                        <img src="{{ $kid->profilePic }}" alt="kids" style="height:98px;width:98px;border-radius:10px;margin-left: auto;margin-right: auto;display: block;">
                                      <?php } ?>
                                    </div>
