                            ...
                            (e.controllers.bar = e.DatasetController.extend({
                                ...
                                draw: function () {
                                    var t = this.chart,
                                        ...
                                        o = 0;
                                    for (
                                        S.canvas.clipArea(t.ctx, t.chartArea);
                                        o < a;
                                        ++o
                                    )
                                ...
                                (e.controllers.horizontalBar =
                                    e.controllers.bar.extend({
                                        getValueScaleId: function () {
                                            return this.getMeta().xAxisID;
                                        },
                                        getIndexScaleId: function () {
                                ...
                                updateElement: function (t, e, i) {
                                    ...
                                    void 0 !== l.radius &&
                                        ...
                                        (t._model = {
                                            ...
                                            tension: r.dataset._model
                                                ? r.dataset._model.tension
                                                : 0,
                                            steppedLine:
                                                !!r.dataset._model &&
                                                r.dataset._model.steppedLine,
                                            hitRadius:
                                                s.hitRadius ||
                                                g.valueAtIndexOrDefault(
                                                    l.pointHitRadius,
                                ...
                                t.DatasetController.extend({
                                    ...
                                    _updateRadius: function () {
                                        ...
                                        (e.outerRadius = Math.max(
                                            ...
                                            (t.outerRadius =
                                                e.outerRadius -
                                                e.radiusLength * t.index),
                                            (t.innerRadius =
                                                t.outerRadius - e.radiusLength);
                                    },
                                    updateElement: function (t, e, i) {
                                        var n = this,
                                            a = n.chart,
                                            ...
                                            f = t.hidden
                                                ? 0
                                                : l.getDistanceFromCenterForValue(
                                                      o.data[e]
                                                  ),
                                            g = n._starts[e],
                                            p =
                                                g +
                                                (t.hidden ? 0 : n._angles[e]),
                                            m = s.animateScale
                                                ? 0
                                                : l.getDistanceFromCenterForValue(
                                                      o.data[e]
                            ...
                            t.controllers.radar = t.DatasetController.extend({
                                ...
                                updateBezierControlPoints: function () {
                                    ...
                                    u.each(o.data, function (t, e) {
                                        var i = t._model,
                                            n = u.splineCurve(
                                                u.previousItem(o.data, e, !0)
                                                    ._model,
                                                i,
                                                u.nextItem(o.data, e, !0)
                                                    ._model,
                                                i.tension
                                            );
                            ...
                            h.extend(u.prototype, {
                                ...
                                resize: function (t) {
                                    var e = this,
                                        ...
                                        o = Math.max(
                                            0,
                                            Math.floor(h.getMaximumWidth(n))
                                        ),
                                        r = Math.max(
                                            0,
                                            Math.floor(
                                ...
                                buildOrUpdateScales: function () {
                                    var r = this,
                                        ...
                                        s = r.scales || {},
                                        e = [],
                                        l = Object.keys(s).reduce(function (
                                            t,
                                            e
                                        ) {
                                            return (t[e] = !1), t;
                                ...
                                updateDatasets: function () {
                                    if (
                                        !1 !==
                                        g.notify(this, "beforeDatasetsUpdate")
                                    ) {
                                        for (
                                            var t = 0,
                                ...
                                updateDataset: function (t) {
                                    var e = this.getDatasetMeta(t),
                                        i = { meta: e, index: t };
                                    !1 !==
                                        g.notify(this, "beforeDatasetUpdate", [
                                            i,
                                        ]) &&
                                        (e.controller.update(),
                                        g.notify(this, "afterDatasetUpdate", [
                                            i,
                                        ]));
                                },
                                render: function (t) {
                                ...
                                drawDatasets: function (t) {
                                    ...
                                    if (
                                        !1 !==
                                        g.notify(e, "beforeDatasetsDraw", [t])
                                    ) {
                                        for (
                                            var i =
                                ...
                                drawDataset: function (t, e) {
                                    ...
                                    !1 !==
                                        g.notify(this, "beforeDatasetDraw", [
                                            n,
                                        ]) &&
                                        (i.controller.draw(e),
                                        g.notify(this, "afterDatasetDraw", [
                                            n,
                                        ]));
                                },
                                _drawTooltip: function (t) {
                                    ...
                                    !1 !==
                                        g.notify(this, "beforeTooltipDraw", [
                                            i,
                                        ]) &&
                                        (e.draw(),
                                        g.notify(this, "afterTooltipDraw", [
                                            i,
                                        ]));
                                },
                    ...
                    e.exports = function () {
                        ...
                        (g.configMerge = function () {
                            ...
                            (g.getRelativePosition = function (t, e) {
                                ...
                                var l = parseFloat(
                                        g.getStyle(o, "padding-left")
                                    ),
                                    u = parseFloat(
                                        g.getStyle(o, "padding-top")
                                    ),
                                    d = parseFloat(
                                        g.getStyle(o, "padding-right")
                                    ),
                                    c = parseFloat(
                                        g.getStyle(o, "padding-bottom")
                                    ),
                        ...
                        return o.length
                            ? (n.data.datasets.forEach(function (t, e) {
                                  if (n.isDatasetVisible(e)) {
                                      var i =
                                          n.getDatasetMeta(e).data[o[0]._index];
                    ...
                    y._set("scale", {
                        ...
                        (e.exports = n.extend({
                            ...
                            afterBuildTicks: function () {
                                H.callback(this.options.afterBuildTicks, [
                                    this,
                                ]);
                            },
                            ...
                            fit: function () {
                                ...
                                if (
                                    ...
                                    var c =
                                        C(o) +
                                        H.options.toPadding(o.padding).height;
                            ...
                            draw: function (S) {
                                ...
                                if (D.display) {
                                                ...
                                                o =
                                                    ...
                                                    D.offset ===
                                                        ...
                                                        ? ((i =
                                                          ...
                                                          (n = A.zeroLineColor),
                                                          (a =
                                                              A.zeroLineBorderDash),
                                                          A.zeroLineBorderDashOffset)
                                                        : ((i =
                                                              H.valueAtIndexOrDefault(
                                                                  A.lineWidth,
                                                                  e
                                                              )),
                                                          (n =
                                    ...
                                    if (A.drawBorder) {
                                        (r.lineWidth = H.valueAtIndexOrDefault(
                                            A.lineWidth,
                                            0
                                        )),
                                            (r.strokeStyle =
                    ...
                    e.exports = {
                        formatters: {
                            ...
                            logarithmic: function (t, e, i) {
                                var n =
                                    t / Math.pow(10, Math.floor(l.log10(t)));
                                return 0 === t
                                    ? "0"
                                    : 1 === n ||
                                      2 === n ||
                            ...
                            if (S.length) {
                                ...
                                for (e = 0, i = S.length; e < i; ++e)
                                    O.push(
                                        ...
                                        {
                                            xLabel: v
                                                ? v.getLabelForIndex(x, y)
                                                : "",
                                            yLabel: b
                                                ? b.getLabelForIndex(x, y)
                                                : "",
                                            index: x,
                                            datasetIndex: y,
                                            x: m._model.x,
                                ...
                                M.filter &&
                                    ...
                                    R.each(O, function (t) {
                                        T.push(
                                            ...
                                            F.push(
                                                M.callbacks.labelTextColor.call(
                                                    k,
                                                    t,
                                                    k._chart
                                                )
                            ...
                            a.length &&
                                ...
                                R.each(a, function (t) {
                                    n.fillText(t, e.x, e.y),
                                        (e.y +=
                                            i.footerFontSize + i.footerSpacing);
                                }));
                        },
                                ...
                                for (
                                    this._loop && s.length && s.push(s[0]),
                                        ...
                                        o.lineJoin =
                                            ...
                                            l.borderJoinStyle,
                                        o.lineWidth =
                                            a.borderWidth || l.borderWidth,
                                        o.strokeStyle =
                                            a.borderColor || c.defaultColor,
                                        o.beginPath(),
                                        u = -1,
                                        t = 0;
                                    t < s.length;
                        ...
                        var e = {
                            ...
                            i = t.LinearScaleBase.extend({
                                determineDataLimits: function () {
                                    ...
                                    (r.min =
                                        isFinite(r.min) && !isNaN(r.min)
                                            ? r.min
                                            : 0),
                                        (r.max =
                                            isFinite(r.max) && !isNaN(r.max)
                                                ? r.max
                                                : 1),
                                    ...
                                    a = (t.ticks = (function (t, e) {
                                        ...
                                        (u = c.almostEquals(
                                            ...
                                            a < (n = 1) &&
                                                ((n = Math.pow(
                                                    10,
                                                    1 - Math.floor(c.log10(a))
                                                )),
                                                (s = Math.round(s * n) / n),
                                                (l = Math.round(l * n) / n)),
                                            o.push(
                                                void 0 !== t.min ? t.min : s
                                            );
                                        for (var d = 1; d < u; ++d)
                                            o.push(
                                                Math.round((s + d * a) * n) / n
                                            );
                                        return (
                                            o.push(
                                                void 0 !== t.max ? t.max : l
                                            ),
                                            o
                                        );
                                    })(n, t));
                            ...
                            e = n.extend({
                                ...
                                convertTicksToLabels: function () {
                                    (this.tickValues = this.ticks.slice()),
                                        n.prototype.convertTicksToLabels.call(
                                            this
                                        );
                                },
                                getLabelForIndex: function (t, e) {
                                ...
                                getValueForPixel: function (t) {
                                    ...
                                    if (
                                        ...
                                        (a = o.isHorizontal()
                                            ? ((e = o.width),
                                              r ? o.right - t : t - o.left)
                                            : ((e = o.height),
                                              r ? t - o.top : o.bottom - t)) !==
                                            i)
                                    ) {
                                        if (0 === i) {
                        ...
                        var i = e.LinearScaleBase.extend({
                            ...
                            determineDataLimits: function () {
                                ...
                                k.each(i.data.datasets, function (t, e) {
                                    ...
                                    (a.min =
                                        o === Number.POSITIVE_INFINITY ? 0 : o),
                                    (a.max =
                            ...
                            convertTicksToLabels: function () {
                                var t = this;
                                e.LinearScaleBase.prototype.convertTicksToLabels.call(
                                    t
                                ),
                            ...
                            draw: function () {
                                ...
                                if (t.display) {
                                    ...
                                    k.each(o.ticks, function (t, e) {
                                        if (0 < e || s.reverse) {
                                            var i =
                                                o.getDistanceFromCenterForValue(
                                                    o.ticksAsNumbers[e]
                                                );
                                            if (
                                                (r.display &&
                        ...
                        var t = n.extend({
                            ...
                            determineDataLimits: function () {
                                var t,
                                    ...
                                    g = [];
                                for (
                                    t = 0, i = s.data.labels.length;
                                    t < i;
                                    ++t
                                )
                                    g.push(S(s.data.labels[t], r));
                                for (
                                    t = 0, i = (s.data.datasets || []).length;
                                    t < i;
                                    ++t
                                )
