...
--
-- Host: localhost:3306
-- Generation Time: May 05, 2023 at 01:45 AM
...
CREATE TABLE `groups` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `createdByTeacherId` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `students` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `hex` enum('#F8DF81','#F6AA90','#F6B4BF','#D5B6D5','#BADFDA','#9BD0B7','#E5EBD7','#96C3EB','#E6E6E6','#FFE3D1') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
